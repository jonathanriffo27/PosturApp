        ...
        <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <button
                    ...
                    className="w-full bg-white border-2 border-slate-200 text-slate-700 py-3 rounded-xl font-semibold hover:bg-slate-50 hover:border-slate-300 hover:shadow-md transition-all disabled:opacity-50 flex items-center justify-center gap-3"
                >
                    ...
                    <span className="font-medium">{googleLoading ? 'Cargando...' : 'Continuar con Google'}</span>
                </button>
                ...
                <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center">
                        <span className="bg-white px-4 text-xs uppercase tracking-wider text-slate-400 font-medium">o continúa con email</span>
                    </div>
                </div>
