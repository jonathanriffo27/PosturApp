...
const LoginForm = ({ onClose }) => {
    const { loginWithEmail, signupWithEmail, loginWithGoogle, error } = useAuth();
    ...
    return (
        <dialog
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop:backdrop-blur-sm rounded-2xl border-0 shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto"
        >
            <div className="w-full p-5 space-y-4">
                ...
                <button
                    ...
                    className="w-full bg-white border border-slate-200 text-slate-700 py-2.5 rounded-xl font-medium hover:bg-slate-50 transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-sm"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-primary text-white py-2.5 rounded-xl font-medium hover:bg-primary/90 transition-all disabled:opacity-50 text-sm"
                    >
